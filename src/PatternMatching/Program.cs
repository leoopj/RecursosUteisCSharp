...
ExibirInformacoesCotacaoUsingSwitch(dolar);
DecisaoViagem(dolar);
...
//Metodo sem pattern matching
// static void ExibirInformacoesCotacao(Cotacao cotacao)
// {
...
//Metodo com patern matching usando switch
static void ExibirInformacoesCotacaoUsingSwitch(Cotacao cotacao)
{
   double valorCotacao;
   switch (cotacao)
   {
